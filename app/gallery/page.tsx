...
const galleryData: GalleryItem[] = [
  {
    ...
    meta: "LOCATION: SECTOR_7G",
  },
  {
    id: "2",
    category: "ARENA",
    title: "EXTERIOR_MURAL",
  ...
  },
  {
    ...
    category: "RUNNER",
    title: "SPEED_RACER",
    src: "/media/games/7.png",
    meta: "G-FORCE: ENABLED",
  },
  {
    id: "9",
    category: "MISSION",
    title: "GUN_FIGHT_HERO",
    src: "/media/games/8.png",
    meta: "ACCESS: ALL_RANKS",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div className="space-y-4">
            <div className="flex items-center gap-4 mb-2">
              ...
              <span className="text-primary font-pixel text-[10px] tracking-widest uppercase">
                Visual_Archive_Explorer
              </span>
            </div>
            <h1 className="text-5xl md:text-7xl font-pixel text-white">
              <GlitchText text="DECRYPTED" color="white" persistent />
              <br />
              <span className="text-secondary neon-glow-magenta">
                <ShuffleText text="FILES" delay={400} />
              </span>
            </h1>
          </div>
        ...
        <div className="mt-20 p-8 border border-dashed border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 bg-white/5 backdrop-blur-sm">
          <div className="space-y-1">
            <div className="text-[10px] font-pixel text-primary uppercase">
              Archive_Status
            </div>
            <div className="text-xs text-slate-400 font-body">
              All visual data encrypted via{" "}
              <span className="text-white">QUANTUM_VAULT_7</span>. Unauthorized
              replication will result in immediate neural disconnect.
            </div>
          </div>
          <div className="flex gap-4 items-center">
            <div className="text-right">
              <div className="text-[8px] font-pixel text-slate-600">
                STORAGE_LOAD
              </div>
