...
const experiences = [
  ...
  },
  {
    ...
    description:
      "Arcade-style shooting experience. Test your aim and reflexes in intense combat.",
  },
];
...
const ExperienceShowcase: React.FC<ExperienceShowcaseProps> = () => {
  return (
    <section
      id="experiences"
      className="py-16 md:py-32 bg-background-dark relative border-t border-white/5 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="mb-12 md:mb-16">
          <div className="flex items-center justify-center md:justify-start gap-4 mb-4">
            ...
            <span className="text-primary font-pixel text-[8px] md:text-[10px] tracking-widest uppercase font-bold">
              CHOOSE_YOUR_REALITY
            </span>
          </div>
                ...
                <div className="p-6 space-y-4 border-t border-white/5">
                  ...
                  <div className="flex justify-between items-center text-[10px] font-pixel">
                    <div className="space-y-1">
                      ...
                      <div
                        className={`font-black ${exp.difficulty === "ELITE" ? "text-secondary" : "text-primary"}`}
                      >
                        {exp.difficulty}
                      </div>
                    </div>
