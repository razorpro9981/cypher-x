          ...
          <div className="space-y-8 text-base md:text-xl text-slate-300 font-medium leading-[1.8] max-w-xl tracking-wide">
            <div className="relative">
              ...
              <p className="pl-8 py-2">
                <span className="text-brand-yellow font-black block text-[10px] mb-4 font-pixel tracking-[0.2em]">
                  [EST_2021.LOG]
                </span>
                <span className="text-white font-bold">Cypher Zone X</span> was
                born in the digital underground of Accra, founded by a
                collective of hackers and artists who believed reality was just
                a poorly optimized operating system.
              </p>
            </div>

            <p className="drop-shadow-sm leading-relaxed">
              Our mission is absolute: to provide an escape velocity from the
              mundane. We don&apos;t just sell VR sessions; we provide the keys
              to a multiverse where{" "}
              <span className="text-primary italic">
                physics is a suggestion
              </span>{" "}
              and your{" "}
              <span className="text-secondary italic">imagination</span> is the
              ...
              <div className="relative overflow-hidden aspect-[4/5] group">
                ...
                <div className="absolute bottom-10 left-10 right-10 p-6 bg-black/90 backdrop-blur-xl border border-brand-yellow/30 shadow-[0_0_30px_rgba(251,191,36,0.2)]">
                  <div className="flex justify-between items-start mb-4">
                    <div className="text-[10px] font-pixel text-brand-yellow font-black tracking-widest uppercase">
                      SYSTEM_MANIFESTO
                    </div>
                    <div className="flex gap-1">
                      ...
                      ></div>
                      <div
                        className="w-2 h-2 bg-brand-yellow rounded-full animate-pulse"
                        style={{ animationDelay: "0.4s" }}
                      ></div>
                    </div>
                  </div>
                  <div className="text-xs text-slate-300 font-body leading-relaxed font-bold tracking-wider">
                    CORE INTEGRITY: <span className="text-primary">100%</span>
                    <br />
                    ZONE X STABILITY:{" "}
                    <span className="text-secondary">NOMINAL</span>
                    <br />
                    HUMAN OVERRIDE:{" "}
                    <span className="text-brand-yellow">DISABLED</span>
                  </div>
